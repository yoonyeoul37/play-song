...
class PlayerWidget3 : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_player3)
